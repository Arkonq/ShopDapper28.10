...
namespace Shop.UI
{
	class Program
	{
		...
		static ReviewRepository reviewRepository = new ReviewRepository();
		static PurchaseRepository purchaseRepository = new PurchaseRepository();
						...
						while (infoAnswer != 0)
						{
							...
							switch (infoAnswer)
							{
								case 1:
									...
									purchases = purchaseRepository.GetAll(user.Id);
			...
			while (chooseCategoryOrPageAnswer != 0)
			{
				...
				switch (chooseCategoryOrPageAnswer)
				{
					case 1:
						...
						int categoriesOnPage = categoryRepository.CategoriesOnPage(page,pageSize); // подсчет кол-ва записей на странице
						...
						while (chooseItemOrPageAnswer != 0)
						{
							...
							switch (chooseItemOrPageAnswer)
							{
								...
								case 1:
									...
									itemsOnPage = itemRepository.ItemsOnPage(itemsPage, pageSize);
